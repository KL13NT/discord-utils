...
export declare function createLogMessage(message: string, alertLevel: AlertLevel): string;
export declare function parseChannelMention(mention: string): string | undefined;
...
export declare function transformObject<T>(first: Record<string, unknown>, second: Record<string, unknown>): T;
export declare function awaitMessages(channel: TextChannel, member: GuildMember): Promise<string>;
